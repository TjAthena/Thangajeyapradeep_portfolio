...
import { SiDjango, SiPython, SiFigma, SiGreensock, SiThreedotjs, SiApacheairflow, SiMaterialdesign, SiMysql, SiPowerbi } from 'react-icons/si';
import { TbBrandFramerMotion, TbZodiacGemini } from 'react-icons/tb';
...
const skills = [
    ...
    { name: "Django", icon: <SiDjango className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Python", icon: <SiPython className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 sm:row-span-2 row-span-1" },
    { name: "SQL", icon: <SiMysql className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "GitHub", icon: <FaGithub className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "PowerBi", icon: <SiPowerbi className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "GSAP", icon: <SiGreensock className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Gemini", icon: <TbZodiacGemini className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Apache Airflow", icon: <SiApacheairflow className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
